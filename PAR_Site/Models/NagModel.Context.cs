...
namespace PAR_Site.Models
{
    ...
    public partial class NagParDemoEntities : DbContext
    {
        public NagParDemoEntities()
            : base("name=NagParDemoEntities")
        {
        }
        ...
        public virtual DbSet<tblProjectName> tblProjectNames { get; set; }
